...
class Penci_Review_Add_Custom_Metabox_Class {
	...
	public function render_meta_box_content( $post ) {
		...
		<div class="penci-table-meta">
			...
			<!--
			<p>
				<label for="penci_review_etype" class="penci-format-row">Select Custom Type for This Review:</label>
				<select id="penci_review_etype" name="penci_review_etype">
					<option value=""><?php //esc_html_e( "Default Type( follow Customize )", "soledad" ); ?></option>
					<option value="Product" <?php //selected( $review_type, 'Product' ); ?>>Product</option>
					<option value="Book" <?php //selected( $review_type, 'Book' ); ?>>Book</option>
					<option value="Course" <?php //selected( $review_type, 'Course' ); ?>>Course</option>
					<option value="ListItem" <?php //selected( $review_type, 'ListItem' ); ?>>ListItem</option>
					<option value="Episode" <?php //selected( $review_type, 'Episode' ); ?>>Episode</option>
					<option value="Event" <?php //selected( $review_type, 'Event' ); ?>>Event</option>
					<option value="Game" <?php //selected( $review_type, 'Game' ); ?>>Game</option>
					<option value="HowTo" <?php //selected( $review_type, 'HowTo' ); ?>>HowTo</option>
					<option value="LocalBusiness" <?php //selected( $review_type, 'LocalBusiness' ); ?>>LocalBusiness</option>
					<option value="MediaObject" <?php //selected( $review_type, 'MediaObject' ); ?>>MediaObject</option>
					<option value="Movie" <?php //selected( $review_type, 'Movie' ); ?>>Movie</option>
					<option value="MusicPlaylist" <?php //selected( $review_type, 'MusicPlaylist' ); ?>>MusicPlaylist</option>
					<option value="MusicRecording" <?php //selected( $review_type, 'MusicRecording' ); ?>>MusicRecording</option>
					<option value="Organization" <?php //selected( $review_type, 'Organization' ); ?>>Organization</option>
					<option value="Recipe" <?php //selected( $review_type, 'Recipe' ); ?>>Recipe</option>
					<option value="CreativeWorkSeries" <?php //selected( $review_type, 'CreativeWorkSeries' ); ?>>CreativeWorkSeries</option>
					<option value="SoftwareApplication" <?php //selected( $review_type, 'SoftwareApplication' ); ?>>SoftwareApplication</option>
					<option value="CreativeWorkSeason" <?php //selected( $review_type, 'CreativeWorkSeason' ); ?>>CreativeWorkSeason</option>
				</select>
			</p>
			-->
			<p class="review-odd">
